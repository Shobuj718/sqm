    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'ticket' => [
                ...
                'channel' => $this->ticket->channel ?? $this->message['channel'] ?? 'messenger',
                'facebook_post_id' => $this->ticket->facebook_post_id,
                'post_link' => $this->ticket->facebook_post_id ? 'https://www.facebook.com/' . $this->ticket->facebook_post_id : null,
