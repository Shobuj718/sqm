    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Edit {{ $user->name }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="mt-1 flex items-center space-x-2">
                                ...
                                @endif
                                <span class="text-xs text-gray-500 dark:text-gray-400">Joined {{ $user->created_at->format('M j, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Edit User Information</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update the user's account information and permissions.</p>
                </div>

                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="divide-y divide-gray-200 dark:divide-gray-600">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-6 py-6">
                        <div class="mb-4">
                            <h4 class="text-base font-medium text-gray-900 dark:text-gray-100">Change Password (Optional)</h4>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Leave blank to keep the current password unchanged.</p>
                        </div>
